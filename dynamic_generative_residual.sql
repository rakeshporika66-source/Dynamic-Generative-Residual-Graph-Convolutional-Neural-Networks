...
--
-- Database: `dynamic_generative_residual`
--
CREATE DATABASE IF NOT EXISTS `dynamic_generative_residual` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `dynamic_generative_residual`;
...
('1d9y8nxee0iq5x6bgyzw6dxiazkuagib', 'eyJ1c2VyaWQiOjF9:1oRXAV:oNnZY2A3Tdq3JP_6zHu5jXtqnvNIcn7JbLTN0mtqi9A', '2022-09-09 11:06:31.842378'),
...
('81ftmqk15nl1f5yyd1p7pz3bnc8iew51', 'eyJ1c2VyaWQiOjJ9:1tIQWu:BEuMITaznBe6HOpfUXwVDCRP1IhZKz0bEHdj63hDMxM', '2024-12-17 10:53:20.661867'),
('8pa3mgyaduacic0dncxujbft8nufy4cn', 'eyJ1c2VyaWQiOjN9:1qtSg3:fOy-5T4EdLDg1M-JFK1L1yoxEO4kiT18m6LQvUQ6MmM', '2023-11-02 13:03:03.437992'),
...
('c0lg1uq4ng5h8x0bxhah8rzqap7khkef', 'eyJ1c2VyaWQiOjF9:1tIQHy:nvuINaAkwJ3fxXUn74ko0RW-Mb1DBT5VFOg0bMwuJdU', '2024-12-17 10:37:54.630419'),
...
('hheeiz42wivi0gnr7bp0lyfqqjj0ekcf', 'eyJ1c2VyaWQiOjF9:1qtRAB:icEzFAarrM_30hA6La8CyL3_Wt1nPwZORx40D1VX4rQ', '2023-11-02 11:26:03.678159'),
...
('u247fzpgwilphavvjnhmazzr4e1iqv6i', 'eyJ1c2VyaWQiOjN9:1oRZfl:-Q44jU5jWwg8u5nVNDdkj9Cegqu9looM7A8m0QtJAUs', '2022-09-09 13:46:57.862989'),
...
(1, 'Govind', 'Govind123@gmail.com', 'Govind', '9535866270', 'India', 'Karnataka', 'Bangalore'),
...
(6, 'Convolutional Neural Networks (CNN)', '47.985347985347985'),
(7, 'SVM', '46.52014652014652'),
(8, 'Logistic Regression', '46.52014652014652'),
(9, 'Decision Tree Classifier', '43.956043956043956'),
(10, 'SGD Classifier', '46.88644688644688');
...
(7, 'Electricity Theft Not Detected', '80.0'),
(8, 'Electricity Theft Detected', '20.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_electricity_theft_detection`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_electricity_theft_detection` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `Consumed_Power_Units` varchar(300) NOT NULL,
...
--
-- Dumping data for table `remote_user_predict_electricity_theft_detection`
--

INSERT INTO `remote_user_predict_electricity_theft_detection` (`id`, `Fid`, `Age`, `Gender`, `Street`, `City`, `Latitude`, `Longitude`, `DateTime`, `Consumed_Power_Units`, `Sector`, `Division`, `Prediction`) VALUES
(1, '10.42.0.211-10.42.0.1-29935-53-17', '70', 'Male', '7900 Alderbridge Way', 'Richmond', '49.176868', '-123.138875', '04-01-23 13:35', '1662', 'Transportation', 'Div5', 'Electricity Theft Not Detected'),
(2, '183.57.48.84-10.42.0.151-80-42112-6', '55', 'Male', '59 West Pender Street', 'Vancouver', '49.28123', '-123.106776', '04-01-23 14:06', '5764', 'Industrial', 'Div15', 'Electricity Theft Detected'),
(3, '174.35.73.97-10.42.0.211-80-54412-6', '57', 'Male', '569 Powell Street', 'Vancouver', '49.283304', '-123.09179', '04-01-23 16:12', '1712', 'Commerical', 'Div10', 'Electricity Theft Not Detected'),
(4, '10.42.0.211-10.42.0.1-51819-53-17', '33', 'Male', '4380 Lorimer Road', 'Whistler', '50.120463', '-122.954906', '05-01-23 8:36', '27065', 'Industrial', 'Div6', 'Electricity Theft Not Detected'),
(5, '202.77.129.230-10.42.0.211-80-47955-6', '70', 'Male', '1128 Hornby Street', 'Vancouver', '49.278937', '-123.126832', '06-01-23 9:18', '2045', 'Commercial Shops', 'Div7', 'Electricity Theft Not Detected');
